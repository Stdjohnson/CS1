...
{-e is bound to the result of the function evenb applied to (S r).
idris will continue to evaluate or reduce the function until it is
only an object value without a function left in it. So the reduction
